      ...
      <div className="section-wrap">
        ...
        <div className="contact-box glass">
          ...
          <div className="contact-info-grid">
            <a href="mailto:hsttasin90@gmail.com" className="contact-item glass">
            ...
            <a href="tel:+8801887238025" className="contact-item glass">
              <span className="contact-icon">📞</span>
              <div className="contact-details">
                <span className="contact-label">Call Me</span>
                <span className="contact-val">+880 1887-238025</span>
              </div>
            </a>
            <a href="https://wa.me/8801887238025" target="_blank" rel="noopener noreferrer" className="contact-item glass">
              <span className="contact-icon">💬</span>
              <div className="contact-details">
