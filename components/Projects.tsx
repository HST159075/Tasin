...
const projectsData = [
  {
    ...
    challenges:
      "Building a synchronized real-time countdown for thousands of users simultaneously was the biggest hurdle. I implemented a robust server-side clock synchronization to ensure fairness in bidding.",
    future:
      "Plans to integrate AI-driven price suggestions for sellers and an automated dispute resolution system.",
  },
  {
    id: 2,
    ...
    challenges:
      "Handling complex state management for user watchlists across multiple devices while maintaining high performance with the TMDB API was a key challenge.",
    future:
      "Implementing a community-based 'Party Watch' feature where users can watch trailers and discuss in real-time.",
  },
  {
    id: 3,
    ...
    challenges:
      "Designing a categorization system that is both medically accurate and user-friendly for non-expert customers was difficult. I consulted pharmaceutical guidelines for the structure.",
    future:
      "Integration with a digital prescription scanning feature using OCR technology for automated orders.",
  },
  {
    id: 4,
    ...
    challenges:
      "Implementing a seamless cart and checkout flow with user authentication while ensuring a premium UI/UX design matching the brand's aesthetic.",
    future:
      "Integrating an AI-powered product recommendation system based on user skin type and preferences.",
  },
  {
    id: 5,
    ...
    challenges:
      "Designing a multilingual UI (English & Arabic) that maintains aesthetic consistency and provides a premium user experience across all devices.",
    future:
      "Implementing an online fitting system where users can upload measurements and preview fabric combinations in 3D.",
  },
];
  ...
  return (
    ...
    >
      <div className="max-w-[1100px] mx-auto px-4 relative z-10">
        {/* Header */}
        <div className="flex flex-col items-start text- mb-[140px]">
          <motion.div
                  ...
                  <div className="flex flex-col gap-4 relative z-10 mt-2 flex-grow px-2">
                    ...
                    <div className="flex flex-wrap gap-2 items-center mt-2">
                      ...
                      {project.tags.slice(0, 3).map((tag) => (
                        <span
                          key={tag}
                          className="text-[10px] font-bold uppercase tracking-widest px-2 py-1 bg-white/5 text-gray-300 rounded group-hover:bg-orange-500/10 group-hover:text-orange-200 transition-colors duration-300"
                        >
                          {tag}
                        </span>
                      ))}
            ...
            >
              ...
              >
                ...
                <div className="mt-8 flex flex-wrap gap-2">
                  <span className="text-xs font-medium text-white/50 mr-1 mt-1">
                    Tech:
                  </span>
                  {selectedProject.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs font-bold uppercase tracking-widest px-3 py-1.5 bg-white/5 text-gray-300 rounded group-hover:bg-orange-500/10 group-hover:text-orange-200 transition-colors duration-300"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex flex-col gap-6">
                  <div>
                    <h4 className="text-sm font-bold text-white flex items-center gap-2 mb-3 uppercase tracking-widest">
                      <Trophy size={16} className="text-orange-500" /> Key
                      Challenge
                    </h4>
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white flex items-center gap-2 mb-3 uppercase tracking-widest">
                      <Lightbulb size={16} className="text-orange-500" /> Future
                      Scope
                    </h4>
                    <p className="text-sm text-muted leading-relaxed">
                ...
                <div className="mt-auto pt-6 flex flex-wrap gap-4">
                  ...
                  {selectedProject.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white border border-white/10 font-bold py-3 px-6 rounded-xl transition-colors"
                    >
